const { viewAllBooksFrontend, viewBooksByTitleSearchBar, viewBooksByAuthorSearchBar, viewBooksByFilterOption, createNewBookFrontend, deleteBookFrontend, updateSelectedBookFrontend } = require('../frontend.async/books.automation.async');

jest.setTimeout(30000);

describe('Create Books Automation Testing', () => {
    test('Create book with all required information', async () => {
        const bookImageFile = '../sampleBookData/TheBestOfMe.jpg';
        const bookContentFile = '../sampleBookData/TheBestOfMe_Content.pdf';
        const bookName = 'The Best of Me The Bad Version';
...
describe('Update Books Automation Testing', () => {
    test('Update book with all required information', async () => {
        const bookImageFile = '../sampleBookData/TheBestOfMe1.jpg';
        const bookContentFile = '../sampleBookData/TheBestOfMe_Content.pdf';
        const bookName = 'The Best of Me The Good Version';
        const bookAuthor = 'Nicholas Sparks';
    ...
    test('Update book but book genre mistake', async () => {
        const bookImageFile = '../sampleBookData/TheBestOfMe.jpg';
        const bookContentFile = '../sampleBookData/TheBestOfMe_Content.pdf';
        const bookName = 'The Best of Me';
        const bookAuthor = 'Nicholas Sparks';
    ...
    test('Update book without book image', async () => {
        const bookImageFile = null;
        const bookContentFile = '../sampleBookData/TheBestOfMe_Content.pdf';
        const bookName = 'The Best of Me';
        const bookAuthor = 'Nicholas Sparks';
    ...
    test('Update book without book title', async () => {
        const bookImageFile = '../sampleBookData/TheBestOfMe1.jpg';
        const bookContentFile = '../sampleBookData/TheBestOfMe_Content.pdf';
        const bookName = null;
        const bookAuthor = 'Nicholas Sparks';
    ...
    test('Update book without book author', async () => {
        const bookImageFile = '../sampleBookData/TheBestOfMe.jpg';
        const bookContentFile = '../sampleBookData/TheBestOfMe_Content.pdf';
        const bookName = 'The Best of Me';
        const bookAuthor = null;
    ...
    test('Update book without book genre', async () => {
        const bookImageFile = '../sampleBookData/TheBestOfMe1.jpg';
        const bookContentFile = '../sampleBookData/TheBestOfMe_Content.pdf';
        const bookName = 'The Best of Me';
        const bookAuthor = 'Nicholas Sparks';
    ...
    test('Update book without book content', async () => {
        const bookImageFile = '../sampleBookData/TheBestOfMe.jpg';
        const bookContentFile = null;
        const bookName = 'The Best of Me';
        const bookAuthor = 'Nicholas Sparks';
    ...
    test('Update book without all required information', async () => {
        const bookImageFile = null;
        const bookContentFile = null;
        const bookName = null;
        const bookAuthor = null;
